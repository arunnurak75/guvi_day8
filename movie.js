...
let movie1 = new movie("BEAST","SUN STUDIO","U");
movie1.Title();
movie1.Studio();
movie1.Rating();
...
let movie2 = new movies("VALIMAI","ZEE STUDIO");
movie2.Title();
movie2.Studio();
movie2.Rating();
...
class   movieNew extends moviess {
   
getPG(){
      console.log(`only PG rating movies is "${this.title}" rating is"${this.rating}"`)
    }
 }
let movie3 = new movieNew("DARBAR","SUN STUDIO","PG13");
movie3.Title();
movie3.Studio();
movie3.Rating();
movie3.getPG();
